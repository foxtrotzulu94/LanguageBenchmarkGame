...
def setup():
    ...
    print("Need to install Java SDK and Runtime")
    ...
    with open('setup.log', 'w') as logFile:
        ...
        logFile.flush()
        subprocess.call(["javac", "--version"], stdout = logFile, stderr = logFile)
        subprocess.call(["java", "--version"], stdout = logFile, stderr = logFile)
        logFile.flush()
